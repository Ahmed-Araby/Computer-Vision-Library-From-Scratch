...
'''
# mine 
hough_line_transform = lib.hough_line_transform
hough_line_transform.argtypes = [IMAGE , IMAGE]
hough_line_transform.restype = IMAGE

hough_circle_transform=lib.hough_circle_transform
hough_circle_transform.argtypes= [IMAGE ,IMAGE , IMAGE , c_int , c_int , c_int]
hough_line_transform.restype = None
